...
include("header.php");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if (!empty( $_POST ['username'] ) && !empty( $_POST ['password'] )) {
            ...
            if($username == "admin" && $password == "passme"){
				echo"<div id=\"content\" class=\"clearfix\">
				<p>&nbsp</p>
				<p><h2>AdminID: 1</h2></p>
				<p><h2>AdminLevel: Administrator</h></p>
				<p><h2>LastLogin: 2018-01-11</h2></p>
			...
			echo "<form name='logout' id='logout' method='get'>";
			echo '<table>';
            echo '<tr>';
            echo '<td><input type="submit" name="Logout" id="logout" value="logout"></td>';
            echo '</tr>';
			echo '</table>';
			echo '</form>';
...
?>
		   ...
		   if ($_SERVER["REQUEST_METHOD"] != "POST")
    {
            ...
            echo '</tr>';
            echo '<tr>';
            echo '<td><input type="submit" name="submit" id="submit" value="Login"></td>';
            echo '<td><input type="reset" name="reset" id="reset" value="Reset"></td>';
            echo '</tr>';
			echo '</table>';
	}
			?>
