...
$result = mjusqli_query($dbConnection,$sqlQuery);
...
$t=time();
$timwStr=date("Y-m-d",$t). "/" . $t;
$sqlQuery= "UPDATE 'adminuser' SET 'Lasstlogin' = 'date("Y-m-d",$t)' WHERE 'AdminID'=1";


$_SESSION["username"]=$row[1];
$_SESSION["lastlogin"]="$timeStr";
